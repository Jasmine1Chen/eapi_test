...
#define EAPI_LIB_GET_VER(x)   EAPI_UINT8_C (((x)>>24)&UINT8_MAX )
#define EAPI_LIB_GET_BUG(x)   EAPI_UINT8_C (((x)>>16)&UINT8_MAX )
#define EAPI_LIB_GET_REV(x) EAPI_UINT16_C(((x)>> 0)&UINT16_MAX)
#define EAPI_LIB_VER_CREATE(Version,Bugfix,Revision) (\
                      EAPI_UINT32_C(\
                        (((Version )&UINT8_MAX )<<24)|\
                        (((Bugfix)&UINT8_MAX )<<16)|\
                        (((Revision   )&UINT16_MAX)<< 0) \
                      )\
                    )
...
/* Embedded API AAEON Revision */
#define EAPI_LIB_VER 2
#define EAPI_LIB_BUG 0
#define EAPI_LIB_REVISION 0
#define EAPI_LIB_VERSION EAPI_LIB_VER_CREATE(EAPI_LIB_VER, EAPI_LIB_BUG, EAPI_LIB_REVISION)
...
#define EAPI_ID_BOARD_PLATFORM_TYPE_STR    EAPI_UINT32_C(6) /* Platform ID
							     ...
							     * etc...)
							     */
#define EAPI_ID_PRODUCT_NAME_STR           EAPI_UINT32_C(7) /* Product Name String */

#define EAPI_ID_BOARD_CPU_MODEL_NAME_STR	EAPI_UINT32_C(259)	/*CPU Model Name*/   	
...
#define EAPI_ID_BOARD_LIB_VERSION_VAL     EAPI_UINT32_C(0x10001) /* Vendor Specific
                                                                  * (Optional)
                                                                  */
//#define EAPI_ID_AAEON_ACPI_WMI_REVISION_VAL     EAPI_UINT32_C(0x10002) /* AAEON ACPI WMI Spec Revision */

#define EAPI_ID_HWMON_CPU_TEMP            EAPI_UINT32_C(0x20000) /* milli Celsius */
#define EAPI_ID_HWMON_CHIPSET_TEMP        EAPI_UINT32_C(0x20001) /* milli Celsius */
#define EAPI_ID_HWMON_SYSTEM_TEMP         EAPI_UINT32_C(0x20002) /* milli Celsius */

//#define EAPI_ID_HWMON_VCORE_TEMP          EAPI_UINT32_C(0x20003) /* milli Celsius */
//#define EAPI_ID_HWMON_MEMORY_TEMP         EAPI_UINT32_C(0x20004) /* milli Celsius */
//#define EAPI_ID_HWMON_PCIE_GRAPHIC_TEMP   EAPI_UINT32_C(0x20005) /* milli Celsius */
//#define EAPI_ID_HWMON_AMBIENT_TEMP        EAPI_UINT32_C(0x20006) /* milli Celsius */
//#define EAPI_ID_HWMON_PECI_TEMP           EAPI_UINT32_C(0x20007) /* milli Celsius */
...
#define EAPI_ID_HWMON_VOLTAGE_VMEM        EAPI_UINT32_C(0x21020) /* millivolts */
//#define EAPI_ID_HWMON_VOLTAGE_RTC         EAPI_UINT32_C(0x21024) /* millivolts */
#define EAPI_ID_HWMON_VOLTAGE_3VSB        EAPI_UINT32_C(0x21028) /* millivolts */
...
//#define EAPI_ID_HWMON_FAN_POWER_SUPPLY    EAPI_UINT32_C(0x22004) /* RPM */
 ...
 */
/* IDS */
#define EAPI_ID_FAN_1           EAPI_UINT32_C(0)
#define EAPI_ID_FAN_2           EAPI_UINT32_C(1)
#define EAPI_ID_FAN_3           EAPI_UINT32_C(2)
#define EAPI_ID_FAN_4           EAPI_UINT32_C(3)
#define EAPI_ID_FAN_5           EAPI_UINT32_C(4)
#define EAPI_ID_FAN_6           EAPI_UINT32_C(5)
#define EAPI_ID_FAN_7           EAPI_UINT32_C(6)

/* Fan Values */
#define EAPI_FANSPEED_SET_ON         EAPI_UINT32_C(0)
#define EAPI_FANSPEED_SET_OFF        EAPI_UINT32_C(0xFFFFFFFF)
#define EAPI_FANSPEED_SET_SLOW       EAPI_UINT32_C(0)
#define EAPI_FANSPEED_SET_FULLRUN    EAPI_UINT32_C(255)
#define EAPI_FANMODE_MANUAL          EAPI_UINT32_C(0)
#define EAPI_FANMODE_AUTO            EAPI_UINT32_C(1)
/*
 * EApiGetFanSpeed
 *
 * Condition                              | Return Values
 * ---------------------------------------+------------------------------
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * pSpeed==NULL                           | EAPI_STATUS_INVALID_PARAMETER
 * unknown Id                             | EAPI_STATUS_UNSUPPORTED
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
 ...
 * ---------------------------------------+------------------------------
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * Speed>EAPI_FANSPEED_SET_FULLRUN        | EAPI_STATUS_INVALID_PARAMETER
 * unknown Id                             | EAPI_STATUS_UNSUPPORTED
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
 ...
 * ---------------------------------------+------------------------------
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * pMode==NULL                            | EAPI_STATUS_INVALID_PARAMETER
 * unknown Id                             | EAPI_STATUS_UNSUPPORTED
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
 ...
 * ---------------------------------------+------------------------------
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * Mode>EAPI_FANMODE_AUTO                 | EAPI_STATUS_INVALID_PARAMETER
 * unknown Id                             | EAPI_STATUS_UNSUPPORTED
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
...
/* Watchdog Values */
#define EAPI_WATCHDOG_NO_EXPIRE         EAPI_UINT32_C(0)
#define EAPI_WATCHDOG_HAS_EXPIRED       EAPI_UINT32_C(1)
...
/*
 * A. Initialize the Alerts:
 * Step 1. Get Capability of the specified Alert with calling EApiAlertGetCap() function
 * Step 2. Set Lower Boundary or Upper Boundary of the Alert with calling EApiAlertSetValue() function
 *         Note that the value of boundaries should refer to the capability get from
 *         Step 1.
 *
 * B. Check if the alerts occured:
 * Step 1. Get Alert Status with calling EApiAlertCheck()
 *
 * C. Get current settings of the specified alert:
 * Step 1. Get Capability of the specified Alert with calling EApiAlertGetCap() function
 * Step 2. Calling EApiAlertGetValue() to get the Lower/Upper Boundary value. The effective value is depend on the capability: pBoundarySupport.
 */

/*** Alert Capability: Boundary Support Mask ***/
#define EAPI_ALERT_UPPER_SUPPORTED  EAPI_UINT32_C(0x1 << 1)
#define EAPI_ALERT_LOWER_SUPPORTED  EAPI_UINT32_C(0x1 << 2)
/*** Alert Status Values ***/
#define EAPI_NO_ALERT               EAPI_UINT32_C(0)
#define EAPI_ALERT_OVER_UPPER       EAPI_UINT32_C(1)
#define EAPI_ALERT_LESS_LOWER       EAPI_UINT32_C(2)
 ...
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * Unsupported                            | EAPI_STATUS_UNSUPPORTED
 * pBoundarySupport==NULL                 | EAPI_STATUS_INVALID_PARAMETER
 * pMaxUpperBound==NULL                   | EAPI_STATUS_INVALID_PARAMETER
 * pMinLowerBound==NULL                   | EAPI_STATUS_INVALID_PARAMETER
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
EApiStatus_t
 ...
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * Unsupported                            | EAPI_STATUS_UNSUPPORTED
 * pUpperBound==NULL                      | EAPI_STATUS_INVALID_PARAMETER
 * pLowerBound==NULL                      | EAPI_STATUS_INVALID_PARAMETER
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
EApiStatus_t
 ...
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * Unsupported                            | EAPI_STATUS_UNSUPPORTED
 * (UpperBound > MaxUpperBound)           | EAPI_STATUS_INVALID_PARAMETER
 * (LowerBound < MinLowerBound)           | EAPI_STATUS_INVALID_PARAMETER
 * (LowerBound >= UpperBound)             | EAPI_STATUS_INVALID_PARAMETER
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
EApiStatus_t
 ...
 * Library Uninitialized                  | EAPI_STATUS_NOT_INITIALIZED
 * Unsupported                            | EAPI_STATUS_UNSUPPORTED
 * pAlertSatus==NULL                      | EAPI_STATUS_INVALID_PARAMETER
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
EApiStatus_t
